...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flake8-continuation-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13084&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flake8-continuation-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flake8-continuation` can be installed with:

```
conda install flake8-continuation
```

It is possible to list all of the versions of `flake8-continuation` available on your platform with:
